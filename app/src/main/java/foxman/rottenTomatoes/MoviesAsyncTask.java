        ...
        protected  CurrentUpcoming doInBackground(String... params) {
           CurrentMovies movies = null;
            ...
            try {
                ...
                URL urlTwo = new URL("http://api.rottentomatoes.com/api/public/v1.0/lists/movies/upcoming.json?apikey=cart6246nbex6fqchrj5t4b8&limit=30");
                HttpURLConnection connectionTwo = (HttpURLConnection) urlTwo.openConnection();
                InputStream inTwo = connectionTwo.getInputStream();


                BufferedReader readerTwo = new BufferedReader(
                        new InputStreamReader(inTwo));
                Gson gsonTwo = new Gson();



                movies = gson.fromJson(reader, CurrentMovies.class);
                upcomingMovies = gsonTwo.fromJson(readerTwo, UpcomingMovies.class);
